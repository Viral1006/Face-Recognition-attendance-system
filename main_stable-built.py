...
def contact():
    mess._show(title='Contact Us',
               message="Please contact us on: 'https://github.com/UmangLaad'")
...
def TrainImages():
    check_haarcascadefile()
    assure_path_exists("TrainingImageLabel/")
    recognizer = cv2.face.LBPHFaceRecognizer_create() # LBHP [Local Binary Patterns Histogram]
...
def TrackImages():
    ...
    time_window = 10  # Time window in seconds (Auto- Kill Window) 
